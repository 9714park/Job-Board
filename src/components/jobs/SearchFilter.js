...
function SearchFilter(props) {
  ...
  const onFilterSelected = (locationName) => {
    if (locationName == 'Reset') {
      props.onFilterByLocation(locationName);
  ...
  return (
    <Fragment>
      <Dropdown className='dropdown custom-dropdown mb-0 mr-3 mt-3 mt-sm-0 mb-2'>
        ...
        <Dropdown.Menu className='dropdown-menu dropdown-menu-right'>
          <Dropdown.Item
            ...
            onClick={onFilterSelected.bind(this, 'Toronto')}>
            Toronto
          </Dropdown.Item>
          <Dropdown.Item
            className='dropdown-item '
            onClick={onFilterSelected.bind(this, 'Hamilton')}>
            Hamilton
          </Dropdown.Item>
          <Dropdown.Item
            className='dropdown-item '
            onClick={onFilterSelected.bind(this, 'London')}>
            London
          </Dropdown.Item>
          <Dropdown.Item
            className='dropdown-item '
            onClick={onFilterSelected.bind(this, 'Mississauga')}>
            Mississauga
          </Dropdown.Item>
          <Dropdown.Item
            className='dropdown-item '
            onClick={onFilterSelected.bind(this, 'Ottawa')}>
            Ottawa
          </Dropdown.Item>
          <Dropdown.Item
            className='dropdown-item text-danger'
            onClick={onFilterSelected.bind(this, 'Reset')}>
            Reset
          </Dropdown.Item>
        </Dropdown.Menu>
      </Dropdown>
      ...
      <Dropdown className='dropdown custom-dropdown mb-0 mr-3 mt-3 mt-sm-0 mb-2'>
        ...
        <Dropdown.Menu className='dropdown-menu dropdown-menu-right'>
          <Dropdown.Item className='dropdown-item'>Last 24 Hours</Dropdown.Item>
          <Dropdown.Item className='dropdown-item '>Last 3 Dats</Dropdown.Item>
          <Dropdown.Item className='dropdown-item '>Last 7 Days</Dropdown.Item>
          <Dropdown.Item className='dropdown-item '>Last 14 Days</Dropdown.Item>
          <Dropdown.Item className='dropdown-item '>Last Month</Dropdown.Item>
        </Dropdown.Menu>
      </Dropdown>
      ...
      <Dropdown className='dropdown custom-dropdown mb-0 mr-3 mt-3 mt-sm-0 mb-2'>
        ...
        <Dropdown.Menu className='dropdown-menu dropdown-menu-right'>
          <Dropdown.Item className='dropdown-item'>$50,000+</Dropdown.Item>
          <Dropdown.Item className='dropdown-item '>$70,000+</Dropdown.Item>
          <Dropdown.Item className='dropdown-item '>$90,000+</Dropdown.Item>
          <Dropdown.Item className='dropdown-item '>$120,000+</Dropdown.Item>
          <Dropdown.Item className='dropdown-item '>$150,000+</Dropdown.Item>
        </Dropdown.Menu>
      </Dropdown>
      ...
      <Dropdown className='dropdown custom-dropdown mb-0 mr-3 mt-3 mt-sm-0 mb-2'>
        ...
        <Dropdown.Menu className='dropdown-menu dropdown-menu-right'>
          <Dropdown.Item className='dropdown-item'>Remote</Dropdown.Item>
          <Dropdown.Item className='dropdown-item '>Part-Time</Dropdown.Item>
          <Dropdown.Item className='dropdown-item '>Full-Time</Dropdown.Item>
          <Dropdown.Item className='dropdown-item '>Contract</Dropdown.Item>
          <Dropdown.Item className='dropdown-item '>Internship</Dropdown.Item>
        </Dropdown.Menu>
      </Dropdown>
