    ...
    <Fragment>
      ...
      <Dropdown className='dropdown custom-dropdown mr-3'>
        ...
        <Dropdown.Menu className='dropdown-menu dropdown-menu-right'>
          <Dropdown.Item className='dropdown-item' onClick={onLocationFilterSelected.bind(this, 'Toronto')}>
            Toronto
          </Dropdown.Item>
          <Dropdown.Item className='dropdown-item ' onClick={onLocationFilterSelected.bind(this, 'Hamilton')}>
            Hamilton
          </Dropdown.Item>
          <Dropdown.Item className='dropdown-item ' onClick={onLocationFilterSelected.bind(this, 'London')}>
            London
          </Dropdown.Item>
          <Dropdown.Item
          ...
          <Dropdown.Item className='dropdown-item ' onClick={onLocationFilterSelected.bind(this, 'Ottawa')}>
            Ottawa
          </Dropdown.Item>
          <Dropdown.Item
      ...
      <Dropdown className='dropdown custom-dropdown mr-3'>
        <Dropdown.Toggle
          ...
          {salaryFilterStatus.active ? '$' + salaryFilterStatus.name + '+' : 'SALARY EST.'}
          <i className='las la-angle-down scale5 text-primary ml-3' />
        </Dropdown.Toggle>
        <Dropdown.Menu className='dropdown-menu dropdown-menu-right'>
          <Dropdown.Item className='dropdown-item' onClick={onSalaryFilterSelected.bind(this, 50000)}>
            $50,000+
          </Dropdown.Item>
          <Dropdown.Item className='dropdown-item ' onClick={onSalaryFilterSelected.bind(this, 70000)}>
            $70,000+
          </Dropdown.Item>
          <Dropdown.Item className='dropdown-item ' onClick={onSalaryFilterSelected.bind(this, 90000)}>
            $90,000+
          </Dropdown.Item>
          <Dropdown.Item className='dropdown-item ' onClick={onSalaryFilterSelected.bind(this, 120000)}>
            $120,000+
          </Dropdown.Item>
          <Dropdown.Item className='dropdown-item ' onClick={onSalaryFilterSelected.bind(this, 150000)}>
            $150,000+
          </Dropdown.Item>
          <Dropdown.Item
            className='dropdown-item text-danger '
      ...
      <Dropdown className='dropdown custom-dropdown mr-3'>
        ...
        <Dropdown.Menu className='dropdown-menu dropdown-menu-right'>
          <Dropdown.Item className='dropdown-item ' onClick={onTypeFilterSelected.bind(this, 'Part-Time')}>
            Part-Time
          </Dropdown.Item>
          <Dropdown.Item className='dropdown-item ' onClick={onTypeFilterSelected.bind(this, 'Full-Time')}>
            Full-Time
          </Dropdown.Item>
          <Dropdown.Item className='dropdown-item ' onClick={onTypeFilterSelected.bind(this, 'Contract')}>
            Contract
          </Dropdown.Item>
          <Dropdown.Item className='dropdown-item ' onClick={onTypeFilterSelected.bind(this, 'Internship')}>
            Internship
          </Dropdown.Item>
          <Dropdown.Item className='dropdown-item text-danger ' onClick={onTypeFilterSelected.bind(this, '')}>
            RESET
          </Dropdown.Item>
        </Dropdown.Menu>
      </Dropdown>
