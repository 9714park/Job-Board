...
function DashboardPositions() {
  return (
    <div className='my-4 row py-1'>
      <div className='col-xl-12'>
        <div className='d-sm-flex align-items-center mb-sm-3 mt-sm-2 mt-2  mb-2'>
          <h4 className='fs-20 text-black mr-auto mb-sm-0 mb-2'>Featured Positions</h4>
        </div>
      </div>
      <div className='col-xl-12'>
        <div className='row'>
          <div className='col-xl-3 col-xxl-3 col-lg-3 col-md-4 col-sm-6'>
            <div className='card text-center'>
              <div className='card-body'>
                ...
                <h6 className='font-w600 fs-16 mb-1'>
                  <Link to='/application' className='text-black'>
                    Full-Stack Developer
                  </Link>
                </h6>
                <span className='text-primary'>21 Vacancy</span>
              </div>
            </div>
          </div>
          <div className='col-xl-3 col-xxl-3 col-lg-3 col-md-4 col-sm-6'>
            <div className='card text-center'>
              <div className='card-body'>
                ...
                <span className='text-primary'>17 Vacancy</span>
              </div>
            </div>
          </div>
          <div className='col-xl-3 col-xxl-3 col-lg-3 col-md-4 col-sm-6'>
            <div className='card text-center'>
              <div className='card-body'>
                <svg
                  ...
                  />
                  <path
                    d='M20.6215 59.0077C15.5312 53.9174 12.6715 47.0135 12.6715 39.8148C12.6715 32.6161 15.5312 25.7122 20.6215 20.6219C25.7118 15.5316 32.6156 12.6719 39.8144 12.6719C47.0131 12.6719 53.917 15.5316 59.0073 20.6219L49.4108 30.2183C46.8657 27.6732 43.4137 26.2434 39.8144 26.2434C36.215 26.2434 32.7631 27.6732 30.2179 30.2183C27.6728 32.7635 26.243 36.2154 26.243 39.8148C26.243 43.4141 27.6728 46.8661 30.2179 49.4112L20.6215 59.0077Z'
                    fill='white'
                  />
                </svg>
                <h6 className='font-w600 fs-16 mb-1'>
                ...
                <span className='text-primary'>31 Vacancy</span>
              </div>
            </div>
          </div>
          <div className='col-xl-3 col-xxl-3 col-lg-3 col-md-4 col-sm-6'>
            <div className='card text-center'>
              <div className='card-body'>
                ...
                <span className='text-primary'>7 Vacancy</span>
              </div>
            </div>
          </div>
          <div className='col-xl-3 col-xxl-3 col-lg-3 col-md-4 col-sm-6'>
            <div className='card text-center'>
              <div className='card-body'>
                ...
                <span className='text-primary'>4 Vacancy</span>
              </div>
            </div>
          </div>
          <div className='col-xl-3 col-xxl-3 col-lg-3 col-md-4 col-sm-6'>
            ...
            <div className='card text-center'>
              <div className='card-body'>
                <svg
                  ...
                  />
                  <path
                    d='M20.6215 59.0077C15.5312 53.9174 12.6715 47.0135 12.6715 39.8148C12.6715 32.6161 15.5312 25.7122 20.6215 20.6219C25.7118 15.5316 32.6157 12.672 39.8144 12.672C47.0131 12.672 53.917 15.5316 59.0073 20.6219L49.4108 30.2184C46.8657 27.6732 43.4138 26.2434 39.8144 26.2434C36.215 26.2434 32.7631 27.6732 30.2179 30.2184C27.6728 32.7635 26.243 36.2154 26.243 39.8148C26.243 43.4142 27.6728 46.8661 30.2179 49.4113L20.6215 59.0077Z'
                    fill='white'
                  />
                </svg>
                <h6 className='font-w600 fs-16 mb-1'>
